...
(function() {
  var bindPoiMarkerClick, htmlLunch, iconSize, onPopupClose, onPopupFeatureSelect, onPopupFeatureUnselect, restaurantPopupHtml, transformLonLat;
  ...
  onPopupFeatureSelect = function(feature) {
    return alert("avattiin: " + feature.name);
  };

  onPopupFeatureUnselect = function(feature) {
    return alert("suljettiin: " + feature.name);
  };
